...
export default function RoboticsPage() {
  ...
  const futurePrograms = [
    {
      title: t("roboticsPage.futurePrograms.warehouseRobotics"),
      description: t("roboticsPage.futurePrograms.warehouseRoboticsDesc"),
      icon: <IoHardwareChipOutline size={24} />,
    },
    {
      title: t("roboticsPage.futurePrograms.agricultureRobotics"),
      description: t("roboticsPage.futurePrograms.agricultureRoboticsDesc"),
      icon: <IoFlashOutline size={24} />,
    },
    {
      title: t("roboticsPage.futurePrograms.autonomousIndustrial"),
      description: t("roboticsPage.futurePrograms.autonomousIndustrialDesc"),
      icon: <IoRocketOutline size={24} />,
    },
    {
      title: t("roboticsPage.futurePrograms.droneHybrid"),
      description: t("roboticsPage.futurePrograms.droneHybridDesc"),
      icon: <IoGitNetworkOutline size={24} />,
    },
  ];
  ...
  const techStack = [
    {
      name: t("roboticsPage.techStackItems.roboticsMiddleware.name"),
      description: t(
        "roboticsPage.techStackItems.roboticsMiddleware.description",
      ),
    },
    {
      name: t("roboticsPage.techStackItems.embeddedSystems.name"),
      description: t("roboticsPage.techStackItems.embeddedSystems.description"),
    },
    {
      name: t("roboticsPage.techStackItems.mobilitySystems.name"),
      description: t("roboticsPage.techStackItems.mobilitySystems.description"),
    },
    {
      name: t("roboticsPage.techStackItems.operationalIntelligence.name"),
      description: t(
        "roboticsPage.techStackItems.operationalIntelligence.description",
      ),
    },
    {
      name: t("roboticsPage.techStackItems.aiAutonomy.name"),
      description: t("roboticsPage.techStackItems.aiAutonomy.description"),
    },
  ];
    ...
    <main className="bg-[var(--color-dark-100)]">
        ...
        <div className="relative z-20 max-w-7xl px-6 md:px-12">
          ...
          >
            <div className="mb-5 flex items-center gap-3">
              <div className="h-[2px] w-12 bg-[var(--color-secondary-400)]" />
              <span className="font-mono text-xs uppercase tracking-[0.28em] text-[var(--color-secondary-400)]">
                {t("roboticsPage.badge")}
              </span>
            </div>

            <h1 className="font-heading text-4xl md:text-5xl font-bold uppercase leading-tight text-white mb-5">
              {t("roboticsPage.heading")}
            </h1>

            <p className="font-mono text-base md:text-lg text-[var(--color-text-secondary)] max-w-2xl">
              {t("roboticsPage.description")}
            </p>

            <div className="flex flex-wrap gap-4 mt-8">
              <Link href="/contact" className="btn-primary">
                {t("roboticsPage.discussCollaboration")}
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-2">
              {t("roboticsPage.developmentPrograms")}{" "}
              <span className="text-[var(--color-secondary-400)]">
                {t("roboticsPage.developmentProgramsHighlight")}
              </span>
            </h2>
            <p className="font-mono text-sm text-[var(--color-text-secondary)]">
              {t("roboticsPage.developmentProgramsSubtitle")}
            </p>
          </motion.div>
          ...
          {loading ? (
            <div className="text-center py-20">
              <div className="animate-pulse text-white">
                {t("roboticsPage.loadingPrograms")}
              </div>
            </div>
          ) : robots.length > 0 ? (
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="text-center py-20">
              <p className="text-[var(--color-text-secondary)]">
                {t("roboticsPage.noProgramsFound")}
              </p>
            </div>
          )}
        </div>
      ...
      <section className="relative py-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-2">
              {t("roboticsPage.expandingPrograms")}{" "}
              <span className="text-[var(--color-secondary-400)]">
                {t("roboticsPage.expandingProgramsHighlight")}
              </span>
            </h2>
            <p className="font-mono text-sm text-[var(--color-text-secondary)]">
              {t("roboticsPage.expandingProgramsSubtitle")}
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-2">
              {t("roboticsPage.technologyStack")}{" "}
              <span className="text-[var(--color-secondary-400)]">
                {t("roboticsPage.technologyStackHighlight")}
              </span>
            </h2>
            <p className="font-mono text-sm text-[var(--color-text-secondary)]">
              {t("roboticsPage.technologyStackSubtitle")}
            </p>
          </motion.div>
      ...
      <section className="relative py-20 overflow-hidden border-t border-white/5">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
            {t("roboticsPage.futureTitle")}{" "}
            <span className="text-[var(--color-secondary-400)]">
              {t("roboticsPage.futureHighlight")}
            </span>
          </h2>
          <p className="font-mono text-base text-[var(--color-text-secondary)] mb-8">
            {t("roboticsPage.futureDescription")}
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/contact" className="btn-primary">
              {t("roboticsPage.discussCollaboration")}
