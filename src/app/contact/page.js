...
export default function ContactPage() {
  ...
  const inquiryTypes = [
    t("contactPage.inquiryTypes.roboticsConsulting"),
    t("contactPage.inquiryTypes.coCreationPartnership"),
    t("contactPage.inquiryTypes.dedicatedEngineeringTeams"),
    t("contactPage.inquiryTypes.careers"),
    t("contactPage.inquiryTypes.generalInquiry"),
    t("contactPage.inquiryTypes.technologyCollaboration"),
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="font-mono text-base md:text-lg text-[var(--color-text-secondary)] max-w-2xl mx-auto mt-2">
              <span className="text-[var(--color-secondary-400)]">
                {t("contactPage.subheadingHighlight")}
              </span>{" "}
              {t("contactPage.subheadingSuffix")}
            </p>
      ...
      <section ref={sectionRefs.form} className="relative pb-10">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            className="bg-linear-to-br from-[var(--color-dark-200)] to-[var(--color-dark-300)] rounded-2xl border border-white/10 p-8 md:p-12"
          >
            <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                >
                  <option value="" className="bg-[var(--color-dark-300)]">
                    {t("contactPage.inquiryTypePlaceholder")}
                  </option>
              ...
              >
                {isSubmitting ? (
                  ...
                  <>
                    {t("contactPage.sendButton")} <IoSendOutline size={16} />
                  </>
                )}
              </button>
