...
//               <div className="h-0.5 w-12 bg-[var(--color-secondary-400)]" />
...
//                 whileHover={{ y: -6 }}
//                 className="group relative rounded-xl border border-white/10 bg-white/5 p-6 transition-all duration-300 hover:border-[var(--color-primary-500)]/30 hover:bg-white/10"
//               >
...
export default function IndustriesPage() {
  ...
  const industryCards = [
    {
      icon: <IoCubeOutline size={28} />,
      title: t("industriesPage.industryCards.warehouse"),
      description: t("industriesPage.industryCards.warehouseDesc"),
      capabilities: [
        t("industriesPage.capabilities.warehouseOrchestration"),
        t("industriesPage.capabilities.sortingSystems"),
        t("industriesPage.capabilities.materialHandling"),
        t("industriesPage.capabilities.inventoryTraceability"),
        t("industriesPage.capabilities.roboticsIntegration"),
      ],
      image:
        "https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d?q=80&w=1200&auto=format&fit=crop",
    },
    {
      icon: <IoBuildOutline size={28} />,
      title: t("industriesPage.industryCards.manufacturing"),
      description: t("industriesPage.industryCards.manufacturingDesc"),
      capabilities: [
        t("industriesPage.capabilities.plcSystems"),
        t("industriesPage.capabilities.scadaIntegration"),
        t("industriesPage.capabilities.mesConnectivity"),
        t("industriesPage.capabilities.processMonitoring"),
        t("industriesPage.capabilities.predictiveMaintenance"),
      ],
      image:
        "https://images.unsplash.com/photo-1565008447742-97f6f38c985c?q=80&w=1200&auto=format&fit=crop",
    },
    {
      icon: <IoHardwareChipOutline size={28} />,
      title: t("industriesPage.industryCards.robotics"),
      description: t("industriesPage.industryCards.roboticsDesc"),
      capabilities: [
        t("industriesPage.capabilities.quadrupedRobotics"),
        t("industriesPage.capabilities.autonomousMobility"),
        t("industriesPage.capabilities.roboticsMiddleware"),
    ...
    {
      icon: <IoTrendingUpOutline size={28} />,
      title: t("industriesPage.industryCards.agriculture"),
      description: t("industriesPage.industryCards.agricultureDesc"),
      capabilities: [
        t("industriesPage.capabilities.landBasedAutomation"),
        t("industriesPage.capabilities.autonomousMobility"),
        t("industriesPage.capabilities.smartFieldOperations"),
        t("industriesPage.capabilities.intelligentMonitoringSystems"),
      ],
      image:
        "https://images.unsplash.com/photo-1500937386664-56d1dfef3854?q=80&w=1200&auto=format&fit=crop",
    },
    {
      icon: <IoFlashOutline size={28} />,
      title: t("industriesPage.industryCards.embedded"),
      description: t("industriesPage.industryCards.embeddedDesc"),
      capabilities: [
        t("industriesPage.capabilities.embeddedControllers"),
        t("industriesPage.capabilities.sensorSystems"),
        t("industriesPage.capabilities.roboticsElectronics"),
        t("industriesPage.capabilities.intelligentHardwarePlatforms"),
        t("industriesPage.capabilities.realTimeSystems"),
      ],
      image:
        "https://images.unsplash.com/photo-1518770660439-4636190af475?q=80&w=1200&auto=format&fit=crop",
    },
    {
      icon: <IoCloudOutline size={28} />,
      title: t("industriesPage.industryCards.infrastructure"),
      description: t("industriesPage.industryCards.infrastructureDesc"),
      capabilities: [
        t("industriesPage.capabilities.controlSystems"),
        t("industriesPage.capabilities.industrialDashboards"),
        t("industriesPage.capabilities.operationalIntelligence"),
        t("industriesPage.capabilities.systemIntegration"),
        t("industriesPage.capabilities.monitoringPlatforms"),
      ],
      image:
        "https://images.unsplash.com/photo-1513828583688-c52646db42da?q=80&w=1200&auto=format&fit=crop",
    },
    ...
    <main className="bg-[var(--color-dark-100)]">
      ...
      >
        ...
        <div className="relative z-20 max-w-7xl px-6 md:px-12">
          ...
          >
            ...
            <h1 className="font-heading text-4xl md:text-5xl font-bold uppercase leading-tight text-white mb-5">
              {t("industriesPage.heading")}
            </h1>

            <p className="font-mono text-base md:text-lg text-[var(--color-text-secondary)] max-w-2xl">
              {t("industriesPage.description")}
            </p>

            <div className="flex flex-wrap gap-4 mt-8">
              <Link href="/contact" className="btn-primary">
                {t("industriesPage.discussIndustry")}
              </Link>
              <Link href="/solutions" className="btn-secondary">
                {t("industriesPage.exploreSolutions")}
              </Link>
            </div>
          </motion.div>
        </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl font-semibold uppercase text-white">
              {t("industriesPage.industriesWeServe")}
            </h2>
            <p className="font-mono text-sm text-[var(--color-text-secondary)] mt-3 max-w-2xl mx-auto">
              {t("industriesPage.industriesWeServeSubtitle")}
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
                {t("industriesPage.warehouseTitle")}
              </h2>
              <p className="font-mono text-base text-[var(--color-text-secondary)] mb-6">
                {t("industriesPage.warehouseDescription")}
              </p>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {industryCards[0].capabilities.map((cap, idx) => (
                  <div key={idx} className="flex items-center gap-2">
            ...
            >
              <img
                src={industryCards[0].image}
                alt={t("industriesPage.warehouseTitle")}
                className="w-full h-auto object-cover rounded-xl border border-white/10"
              />
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src={industryCards[1].image}
                alt={t("industriesPage.manufacturingTitle")}
                className="w-full h-auto object-cover rounded-xl border border-white/10"
              />
            </motion.div>
            ...
            >
              <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
                {t("industriesPage.manufacturingTitle")}
              </h2>
              <p className="font-mono text-base text-[var(--color-text-secondary)] mb-6">
                {t("industriesPage.manufacturingDescription")}
              </p>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {industryCards[1].capabilities.map((cap, idx) => (
                  <div key={idx} className="flex items-center gap-2">
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
                {t("industriesPage.roboticsTitle")}
              </h2>
              <p className="font-mono text-base text-[var(--color-text-secondary)] mb-6">
                {t("industriesPage.roboticsDescription")}
              </p>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {industryCards[2].capabilities.map((cap, idx) => (
                  <div key={idx} className="flex items-center gap-2">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 font-mono text-[var(--color-primary-500)] hover:gap-3 transition-all"
              >
                {t("industriesPage.exploreRobotics")}{" "}
            ...
            >
              <img
                src={industryCards[2].image}
                alt={t("industriesPage.roboticsTitle")}
                className="w-full h-auto object-cover rounded-xl border border-white/10"
              />
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <img
                src={industryCards[3].image}
                alt={t("industriesPage.agricultureTitle")}
                className="w-full h-auto object-cover rounded-xl border border-white/10"
              />
            </motion.div>
            ...
            >
              <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
                {t("industriesPage.agricultureTitle")}
              </h2>
              <p className="font-mono text-base text-[var(--color-text-secondary)] mb-6">
                {t("industriesPage.agricultureDescription")}
              </p>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {industryCards[3].capabilities.map((cap, idx) => (
                  <div key={idx} className="flex items-center gap-2">
      ...
      >
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
                {t("industriesPage.embeddedTitle")}
              </h2>
              <p className="font-mono text-base text-[var(--color-text-secondary)] mb-6">
                {t("industriesPage.embeddedDescription")}
              </p>
              <div className="grid grid-cols-2 gap-3 mb-8">
                {industryCards[4].capabilities.map((cap, idx) => (
                  <div key={idx} className="flex items-center gap-2">
            ...
            >
              <img
                src={industryCards[4].image}
                alt={t("industriesPage.embeddedTitle")}
                className="w-full h-auto object-cover rounded-xl border border-white/10"
              />
            </motion.div>
          </div>
      ...
      <section className="relative py-20 overflow-hidden border-t border-white/5">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          <h2 className="font-heading text-3xl md:text-4xl font-semibold text-white mb-4">
            {t("industriesPage.futureTitle")}
          </h2>
          <p className="font-mono text-base text-[var(--color-text-secondary)] mb-8 max-w-2xl mx-auto">
            {t("industriesPage.futureDescription")}
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link href="/contact" className="btn-primary">
              {t("industriesPage.contactUs")}
            </Link>
            <Link href="/solutions" className="btn-secondary">
              {t("industriesPage.exploreTechnologies")}
            </Link>
          </div>
        </div>
      </section>
