...
export default function RoboticsSection() {
  ...
  const programs = [
    {
      ...
      tags: ["Mobility Systems", "Embedded Control", "Robotics Middleware", "Intelligent Locomotion"],
    ...
    },
    {
      ...
      tags: ["Human Interaction", "Autonomous Navigation", "Robotics Software", "Embedded Systems"],
  ...
  const techStack = [
    { name: "Robotics Middleware", description: "ROS 2 infrastructure and distributed robotics systems" },
    { name: "Embedded Systems", description: "Real-time control systems and intelligent hardware platforms" },
    { name: "Mobility Systems", description: "Actuation, locomotion, and robotics motion systems" },
    { name: "Operational Intelligence", description: "Software systems supporting autonomous operations" },
    { name: "AI & Autonomy", description: "Future intelligent decision-making and autonomous robotics infrastructure" },
  ];
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <h2 className="font-heading text-2xl font-semibold uppercase leading-tight text-[var(--color-text-primary)] md:text-4xl">
            ...
            <br />
            <span className="text-[var(--color-secondary-500)]">Robotics Systems</span>
          </h2>
          ...
          <div className="grid gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="font-mono text-sm leading-relaxed text-[var(--color-text-secondary)]">
                VNX Robotics approaches robotics as part of larger intelligent operational ecosystems
                combining automation, embedded systems, software infrastructure, and industrial intelligence.
              </p>
            </div>
            <div className="space-y-3">
              {["Operational Usefulness", "Intelligent Mobility", "Scalable Autonomy", "Long-term Robotics Infrastructure"].map((focus, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  <div className="h-1.5 w-1.5 rounded-full bg-[var(--color-primary-500)]" />
                  <span className="font-mono text-sm text-[var(--color-text-secondary)]">{focus}</span>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="flex gap-2">
              {programs.map((_, idx) => (
                <button
                  ...
                  className={`px-4 py-2 text-sm font-mono transition-all duration-300 rounded-full ${
                    activeProgram === idx
              ...
              <div className="relative aspect-video md:aspect-auto bg-gradient-to-br from-[#006db1]/10 to-transparent overflow-hidden">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    <div className="mb-4 text-6xl">{activeProgram === 0 ? "🐕" : "🤖"}</div>
                ...
                <div className="absolute bottom-4 right-4">
                  <span className="rounded-full bg-[var(--color-primary-500)]/20 px-3 py-1 font-mono text-xs text-[var(--color-primary-500)]">
  ...
  >
    <div className="grid md:grid-cols-2">
      ...
      <div className="relative aspect-video md:aspect-auto bg-gradient-to-br from-[#006db1]/10 to-transparent overflow-hidden">
        ...
        >
          <source src={programs[activeProgram].videoSrc} type="video/mp4" />
          {/* Fallback image if video fails */}
          <img src={programs[activeProgram].imageSrc} alt={programs[activeProgram].title} className="w-full h-full object-cover" />
        </video>
